...
extern "C" {
void LaunchGatherNDFloatInt32(const float* params, const int* indices,
                              float* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDFloatInt64(const float* params, const long long* indices,
                              float* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDDoubleInt32(const double* params, const int* indices,
                               double* output, int index_depth,
                               int64_t indices_nd_size, int64_t slice_size,
                               const int64_t* params_strides,
                               musaStream_t stream);
void LaunchGatherNDDoubleInt64(const double* params, const long long* indices,
                               double* output, int index_depth,
                               int64_t indices_nd_size, int64_t slice_size,
                               const int64_t* params_strides,
                               musaStream_t stream);
void LaunchGatherNDInt32Int32(const int* params, const int* indices,
                              int* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDInt32Int64(const int* params, const long long* indices,
                              int* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDInt64Int32(const long long* params, const int* indices,
                              long long* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDInt64Int64(const long long* params, const long long* indices,
                              long long* output, int index_depth,
                              int64_t indices_nd_size, int64_t slice_size,
                              const int64_t* params_strides,
                              musaStream_t stream);
void LaunchGatherNDBoolInt32(const bool* params, const int* indices,
                             bool* output, int index_depth,
                             int64_t indices_nd_size, int64_t slice_size,
                             const int64_t* params_strides,
                             musaStream_t stream);
void LaunchGatherNDBoolInt64(const bool* params, const long long* indices,
                             bool* output, int index_depth,
                             int64_t indices_nd_size, int64_t slice_size,
                             const int64_t* params_strides,
                             musaStream_t stream);
void LaunchGatherNDHalfInt32(const void* params, const int* indices,
                             void* output, int index_depth,
                             int64_t indices_nd_size, int64_t slice_size,
                             const int64_t* params_strides,
                             musaStream_t stream);
void LaunchGatherNDHalfInt64(const void* params, const long long* indices,
                             void* output, int index_depth,
                             int64_t indices_nd_size, int64_t slice_size,
                             const int64_t* params_strides,
                             musaStream_t stream);
void LaunchGatherNDBFloat16Int32(const void* params, const int* indices,
                                 void* output, int index_depth,
                                 int64_t indices_nd_size, int64_t slice_size,
                                 const int64_t* params_strides,
                                 musaStream_t stream);
void LaunchGatherNDBFloat16Int64(const void* params, const long long* indices,
                                 void* output, int index_depth,
                                 int64_t indices_nd_size, int64_t slice_size,
                                 const int64_t* params_strides,
                                 musaStream_t stream);
...
class MusaGatherNdOp : public MusaOpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    LaunchKernel(params.flat<T>().data(), indices.flat<IndexT>().data(),
                 output->flat<T>().data(), static_cast<int>(index_depth),
                 indices_nd_size, slice_size, d_params_strides, stream);
 ...
 private:
  ...
  void LaunchKernel(const T* params, const IndexT* indices, T* output,
                    int index_depth, int64_t indices_nd_size,
                    int64_t slice_size, const int64_t* d_params_strides,
                    musaStream_t stream);
};
...
#define DEFINE_GATHER_ND_LAUNCHER(T, IndexT, launcher_func)               \
  ...
  void MusaGatherNdOp<T, IndexT>::LaunchKernel(                           \
      const T* params, const IndexT* indices, T* output, int index_depth, \
      int64_t indices_nd_size, int64_t slice_size,                        \
...
#define DEFINE_GATHER_ND_LAUNCHER_HALF(IndexT, launcher_func)                \
  ...
  void MusaGatherNdOp<Eigen::half, IndexT>::LaunchKernel(                    \
    ...
    launcher_func(reinterpret_cast<const void*>(params), indices,            \
                  reinterpret_cast<void*>(output), index_depth,              \
                  indices_nd_size, slice_size, d_params_strides, stream);    \
  }
