...
class MusaPadOp : public MusaOpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    MTOP_CHECK_OK_RUN(pad_op.Run(handle, out_mt, in_mt), "Pad Run", context);
  }
};
